...
public class Main {
    public static void main(String[] args) 
    {
        ...
        System.out.println("Array + Arrays.toString(proA));
        System.out.println("Array + Arrays.toString(proB));
        System.out.println();
        ...
        System.out.println();
        System.out.println("Lista" + la);
        
        //AÑADIMOS ELEMENTO A LISTA Y RECORREMOS
        System.out.println("AÑADIR
        la.add("palabra       Iterator iter1 = la.iterator();
        while(iter1.hasNext()) 
        {
            System.out.print(iter1.next() + " ");
        }           
        System.out.println();
        System.out.println("Longituda Lista: " + la.size());
        ...
        System.out.println("\nCONJUNTOS        System.out.println("Conjunto + a);
        ...
        System.out.println("Diferenciatica: " + c);

        System.out.println("OPERACIONESRICAS: ");
        ...
        System.out.println("DiferenciaticaGen: " + cGen);
    }
